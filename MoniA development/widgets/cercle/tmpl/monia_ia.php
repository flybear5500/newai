...
$phone = $cbUser->getUserData()->getString( 'cb_actia_telephone', '' );
 ...
 -->
	...
	<div id="miamain">
	 ...
	 <small id="question0"></small>
	 	<small id="question1"></small>
 	<small id="question2"></small> 
	<?php echo !empty($phone)? ' <u><a id="smsnb" href="sms:+'.$phone.'">+'.$phone.'</a></u>' :'&nbsp;'; ?>
