...
$aiurl = "https://cercle.business/node-question";
$chatsurl = "https://cercle.business/handle-command";
$data_company_id = 0;
$activ_id = 0;
$act_userid = 0;
 ...
 -->
	...
	<div id="audio-input-template" class="audio">
			<button id="recordButton" class="record-btn">    
    			...
    			<div>
<!-- Microphone Icon -->
<img class="record-icon" src="https://cercle.business/widgets/cercle/assets/record.svg" >


<!-- Stop Icon -->
<img class="stop-icon" src="https://cercle.business/widgets/cercle/assets/stop-record.svg" >
